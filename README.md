...
## ❓ How To Run It
* Basic way: find your code folders (folders name should be: MechanicalKeyboardApp)  right click on it and click "**Open in Windows Terminal**"
