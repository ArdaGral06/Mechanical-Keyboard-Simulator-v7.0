...
STRINGS: Dict[str, Dict[str, str]] = {
    "tr": {
        ...
        "pack_detected"      : "JSON soundpack tespit edildi",
        "pack_name"          : "İsim",
        "pack_type"          : "Tip",
        "pack_sound"         : "Ses dosyası",
        "pack_keys"          : "Tuş sayısı",
        "pack_hint"          : "Tek ses dosyası + keycode sprite sistem (Mechvibes formatı)",
        "pack_use"           : "Bu paketi kullan?",
        "pack_activated"     : "JSON pack modu aktif edildi",
        "pack_skipped"       : "Pack atlandı, klasik .wav taraması başlıyor...",
    },
    "en": {
        ...
        "pack_detected"      : "JSON soundpack detected",
        "pack_name"          : "Name",
        "pack_type"          : "Type",
        "pack_sound"         : "Sound file",
        "pack_keys"          : "Key count",
        "pack_hint"          : "Single audio + keycode sprite system (Mechvibes format)",
        "pack_use"           : "Use this pack?",
        "pack_activated"     : "JSON pack mode activated",
        "pack_skipped"       : "Pack skipped, starting classic .wav scan...",
    },
}
